...
export default class Images extends Component {
  ...
  code = () => {
    this.props.navigation.navigate('Git', {
      url:
        'https://raw.githubusercontent.com/Awadhesh786/ReactNativeExample/master/src/screen/Images.js',
    });
  };
  ...
  render() {
    return (
      <View>
        <Header headerTitle="Image View" back={this.goBack} code={this.code} />
          ...
          <ScrollView showsVerticalScrollIndicator={false}>
            ...
            <View style={{marginTop: 10}}>
              <ScrollView horizontal showsHorizontalScrollIndicator={false}>
                <View>
                  <Image
                    style={{height: 200, width: 200, borderRadius: 30 / 2}}
